!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal fade'>" +
               ...
               "</div></div>" +
              "</div>" +
              "<a class='btn btn-white" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='fa fa-link'></i></a>" +
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal fade'>" +
               "<div class='modal-dialog'><div class='modal-content'>" +
                ...
                "</div></div>" +
              "</div>" +
              "<a class='btn btn-white" + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><i class='fa fa-picture-o'></i></a>" +
            "</li>";
        },
        ...
        "html": function(locale, options) {
            ...
            return "<li class='pull-right'>" +
              "<div class='btn-group'>" +
                "<a class='btn btn-white" + size + "' data-wysihtml5-action='change_view' title='" + locale.html.edit + "' tabindex='-1'><i class='fa fa-code'></i></a>" +
              "</div>" +
            "</li>";
        },
    ...
    var locale = $.fn.wysihtml5.locale = {
        en: {
            ...
            lists: {
                unordered: "Lista n&atilde;o ordenada",
                ordered: "Identar",
                outdent: "Identar",
                indent: "Identar"
            },
